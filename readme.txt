...
You must add coordinates in the z function accordingly to the numbers of coordinates(coordsup and coordsdown) if you want to increase the amounts of coordinates going up or down, otherwise Segmentation Fault.(Only 7x7 coordinates for now)
